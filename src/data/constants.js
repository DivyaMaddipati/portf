export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1WdH4t983DSsqEVLswx8yn6dQMKxxYhlz/view",
...
export const experiences = [
  {
    ...
    role: "Project Intern",
    company: "Enligence Technology Labs, Bhimavaram, A.P",
    date: "Feb 2023 - Apr 2023",
    desc: "Developing an innovative application for question and answer grading",
    skills: [
      "ChatGPT API",
      "Milvus DB",
      "Hasura.io",
      "Similarity Detection Techniques",
      "Python's MoviePy Library",
      "FFmpeg command-line tool",
      "NVIDIA’s Conformer Transducer",
      "OpenAI’s whisper",
    ],
  ...
  },
  {
    ...
    desc: "Involved in Data Preprocessing Techniques for making the data useful for creating Machine Learning models, creating various regression and classification algorithms by using various Scikit-Learn libraries such as Linear creating various regression and classification algorithms by using various Scikit-Learn libraries such as Linear regression, Decision Trees, and Naive Bayes.",
    skills: [
      "Machine Learning"
    ],
...
export const education = [
  ...
  },
  {
    ...
    grade: "A",
    desc: "I completed my class 12 high school education at Sri Chaitanya College of Education, Visakhapatnam, where I completed my Intermediate",
    degree: "BIEAP(XII)",
  },
  {
    id: 2,
    ...
    grade: "B+",
    desc: "I completed my class 10 education at Jawahar Navodaya Vidyalaya (JNV), Vizianagaram, where I completed my secondary education",
    degree: "CBSE(X)",
  },
];
